...
Biologically structured multimodal framework integrating MRI, histopathology, and multi-omics for breast cancer modeling (TCGA-BRCA).  
Accepted at AIPR 2025; to appear in Springer LNCS.
